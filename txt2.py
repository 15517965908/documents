...
def load_txt3(dir_1,dir_2):
	...
	for x in f.readlines():
		...
		z1=z1+1
		with open(dir_2,'r',encoding='GBK') as f2:
...
#统计文本2中的文本
	with open(dir_2,'r',encoding='GBK') as f3:
	...
	x = PrettyTable(['','中文字数','英文字数','数字字数','符号字数','综合'])
	...
	print(x)
	return num,cor_num,is_chu(cor_num,num),zhongwen_num,yingwen_num,shuzi_num,h
#输出函数
def outt(dir1,dir2,dir3):
	output=sys.stdout
	outputfile=open(dir3,'w')
	sys.stdout=outputfile
	y=load_txt3(dir1,dir2)
	#print(y[6])
	outputfile.close()
if __name__ == '__main__':
    outt('221.txt','222.txt','223.txt')
